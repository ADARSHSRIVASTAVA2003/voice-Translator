...
input_label = tk.Label(win, text="Recognized Text ⮯", font=("Helvetica", 12, "bold"), bg="#f0f8ff", fg="#333")

input_label.pack()

input_text = tk.Text(win, height=5, width=50, bg="#ffffff", fg="#000", font=("Arial", 10), relief="groove", bd=2)

input_text.pack()

output_label = tk.Label(win, text="Translated Text ⮯",font=("Helvetica", 12, "bold"), bg="#f0f8ff", fg="#333")
output_label.pack()
output_text = tk.Text(win,  height=5, width=50, bg="#ffffff", fg="#000", font=("Arial", 10), relief="groove", bd=2)
output_text.pack()
...
input_lang_label = tk.Label(win, text="Select Input Language:", font=("Helvetica", 12, "bold"), bg="#f0f8ff", fg="#333")
...
output_lang_label = tk.Label(win, text="Select Output Language:" , font=("Helvetica", 12, "bold"), bg="#f0f8ff", fg="#333")
...
def open_about_page():      # about page
    ...
    github_link = ttk.Label(about_window, text="Real time Translator", underline=True, foreground="blue", cursor="hand2")
